...
```vue
	...
	:style="chatContentStyle">
		...
		<view class="flex align-start justify-start mb-3 position-relative">
			<!-- 头像 -->
			<u--image
			src="https://docs-51yrc-com.oss-cn-hangzhou.aliyuncs.com/chat/avatar-07.png"                    mode="widthFix" width="80rpx" height="80rpx" radius="10rpx"></u--image>
			<!-- 气泡 -->
			<!-- 三角标 -->
		...
		<view class="flex align-start justify-end mb-3 position-relative">
			...
			<!-- 头像 -->
			<u--image
			src="https://docs-51yrc-com.oss-cn-hangzhou.aliyuncs.com/chat/avatar-08.png"                    mode="widthFix" width="80rpx" height="80rpx" radius="10rpx"></u--image>
