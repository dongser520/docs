...
> 1、初中以上学历，零基础，喜欢编程的所有从业人员，从零学起（需学完 <b> <a href="https://study.163.com/course/courseMain.htm?courseId=1213374826&share=2&shareId=480000002289674" target="_blank" title="点击查看第一学期的课程">第一学期的课程</a></b>）；<br/>
...
> 【课程概述】<br/>
> 本季课程作为第二学期第一季的课程，重点带大家从0开始，学习我们网页开发中，必不可少的知识环节：JavaScript，也就是我们常说的`js (脚本)`。<br/><br/>
...
### <a href="/secondless/w-a/javascript基本包装类型" target="_blank" title="点击查看课程文档">章节12.javascript基本包装类型</a>
...
### <a href="/secondless/w-a/函数对象数组小结" target="_blank" title="点击查看课程文档">章节13.函数对象数组小结</a>
...
### <a href="/secondless/w-a/浏览器对象模型BOM及浏览器检测" target="_blank" title="点击查看课程文档">章节14.浏览器对象模型BOM及浏览器检测</a>
...
### <a href="/secondless/w-a/网页文档对象模型DOM" target="_blank" title="点击查看课程文档">章节15.网页文档对象模型DOM</a>
...
### <a href="/secondless/w-a/事件" target="_blank" title="点击查看课程文档">章节16.事件</a>
...
### <a href="/secondless/w-a/表单处理及错误处理与调试" target="_blank" title="点击查看课程文档">章节17.表单处理及错误处理与调试</a>
...
### <a href="/secondless/w-a/数据Cookie、XML、JSON" target="_blank" title="点击查看课程文档">章节18.数据Cookie、XML、JSON</a>
