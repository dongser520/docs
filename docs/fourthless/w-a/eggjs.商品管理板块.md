...
### 2. 商品模块后台开发
特别说明：<br/>
由于商城系统商品模块是整个系统的核心，但是，不同的商城系统它在商品模块这里，没有一个统一的标准，它完全根据业务需求来，因此，商品模块我们就不带大家开发api了，因为一万个不同的商品模块界面，就会有一万种api的接口写法，它完全取决于你的业务和界面设计。因此商品模块，我直接在后台带领大家实操，在网站后台带大家开发一种通用性比较高的商品模块，便于你今后用到其它的项目中。
> 具体查看，<a href="eggjs.商品模块后台开发" target="_blank">商品模块后台开发</a><br/>