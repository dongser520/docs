module.exports = [
    { text: '主页', link: '/' },
    { text: '第一期企业网页开发', link: '/aboutless' },
    { text: '第二期企业网站开发', link: '/secondless/' },
    { text: '第三期移动端(H5/小程序/App)课程', link: '/thirdless/' },
    ...
    },
    {
        ...
        items: [
            ...
            // },
            {
                text: '视频学习网站',
                items: [
                    { text: '网易云课堂', link: 'https://study.163.com/provider/480000002289674/index.htm?share=2&shareId=480000002289674', target: '_blank' },
        ...
        items: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: 'Egg.js中extend中helper调用', link: '/secondless/w-c/Egg.js中extend中helper调用.html' },
                ]
            },
            {
                text: '实用网站',
